...
```{r range_diagrams, fig.align = 'centered', out.width = "50%", out.height = "30%", fig.cap = "Intertidal and geographic ranges of the four species.", echo=FALSE}
knitr::include_graphics(here::here("images", "range_diagrams.png"))
```
